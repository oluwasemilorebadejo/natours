...
var showAlert = function showAlert(type, msg) {
  ...
  window.setTimeout(hideAlert, 5000); // 5000ms = 5s
};
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)("error", "Error logging out! Pls try again");
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "User ".concat(type[0].toUpperCase()).concat(type.slice(1), " updated successfully!"));
            window.setTimeout(function () {
              location.assign("/me");
            }, 1000);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://127.0.0.1:3000/api/v1/bookings/create-checkout-session/".concat(tourId),
            tourId: tourId
          });
        case 3:
          _context.next = 9;
